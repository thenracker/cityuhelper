...
public class FakeDataBuilder {
    ...
    public static ArrayList<Item> getListOfFakeDelivers(){
        ...
        deliveries.add(new Food("Sushi takeout", peter, new LatLng(22.325244, 114.168264)));
        deliveries.add(new Delivery("Make reservation table 11 because of I neeed to see what it would look like on many rows", peter, new LatLng(22.325412, 114.169088)));
        ...
        deliveries.add(new Food("KFC food", kai, new LatLng(22.3397947, 114.1703036)));
        deliveries.add(new Delivery("Package - glass inside", jarrett, new LatLng(22.3359542, 114.1736939)));
        deliveries.add(new Print("Printing 50 pages", peter, new LatLng(22.3385742, 114.1705825)));
        ...
        deliveries.add(new Food("Sushi delivery", kai, new LatLng(22.3400825, 114.1584589)));
        deliveries.add(new Food("Beverage for party", kai, new LatLng(22.3379836, 114.1741875)));
        deliveries.add(new Delivery("Flash disk delivery", peter, new LatLng(22.3372294, 114.1754106)));
        deliveries.add(new Print("Printing attached document", jarrett, new LatLng(22.3353439, 114.1702178)));
        deliveries.add(new Delivery("Museum ticket buy", jarrett, new LatLng(22.3370508, 114.1657975)));
        deliveries.add(new Food("McDonald´s food delivery", kai, new LatLng(22.3300444, 114.1735650)));
        deliveries.add(new Food("KFC food delivery", vladimir, new LatLng(22.3454461, 114.1705181)));
